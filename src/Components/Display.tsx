...
const Display: FC = () => {
    ...
    return (
        ...
        <div id="display" className=" grid grid-cols-2 h-[300px] w-[650px] mt-[25vh] m-auto p-2 bg-stone-200 rounded-md ">
            <div>
                <DrumPads isOn={isOn} setKeyPress={setKeyPress} volume={volume} />
            </div>
            <div className="flex flex-col justify-evenly m-2 w-72 h-66">
